...
const STEPS: Step[] = [
  {
    ...
    title: "The project comes first; technology follows.",
    kicker:
      "We first review the systems already considered and evaluate how intelligent control can be integrated to support your needs, lifestyle, and operations.",
    bullets: [
      "On-site or remote consultation to understand project goals, expectations, and budget",
      "Review of architectural, MEP, and low-current systems planned or already installed",
      "Assessment of smart home integration opportunities that enhance functionality and performance.",
    ],
  },
  {
    id: "engineering",
    ...
    title: "We translate project requirements into a clear, reliable system design.",
    kicker: "Based on the reviewed systems and defined needs, we develop an integrated design that aligns smart home control with the building’s electrical, mechanical, and low-current infrastructure.",
    bullets: [
      "System architecture and control logic tailored to the project requirements",
      "Integration design covering lighting, HVAC, security, audio-video, and other relevant systems",
      "Coordination with architectural, MEP, and IT teams to ensure compatibility and long-term reliability",
    ],
  },
  {
    id: "installation",
  ...
  },
  {
    ...
    title: "Every function verified before handover.",
    kicker:
      "We test, adjust, and validate all systems to ensure they operate exactly as designed and perform reliably in real-world use.",
    bullets: [
      "Functional testing of Control4 automation, integrated building systems, and interfaces",
      "Verification of system logic, scenarios, and inter-system communication",
      "Fine-tuning based on on-site conditions and user feedback",
    ],
  },
  {
    id: "support",
    order: "05",
    label: "Long-Term Support & Responsibility",
    title: "We remain responsible beyond handover.",
    kicker:
      "Our involvement continues after commissioning, providing ongoing support, system updates, and expert assistance as your needs evolve.",
    bullets: [
      "Post-handover support, monitoring, and troubleshooting",
      "Software updates, system optimization, and future enhancements",
      "Long-term service support for Control4 and integrated building systems",
    ],
  },
];
